...
const API_BASE = import.meta.env.VITE_API_BASE_URL || '' // '' uses Vite proxy in dev

export default function N8nTest() {
    const [input, setInput] = useState('')
    const [messages, setMessages] = useState([
        { from: 'bot', text: 'Hi! I forward your message to n8n via /api/n8n/trigger.' }
    ])
    ...
    const send = async () => {
        ...
        setSending(true)
        try {
            // You can shape this however your n8n workflow expects.
            // Works with your current POST->GET adapter too (it converts fields to query params).
            const res = await fetch(`${API_BASE}/n8n/trigger`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    channel: 'web_chat',
                    customer: 'workflow.sg',
                    event: 'message',
                    message: text,
                    ts: Date.now()
                })
            ...
            if (ct.includes('application/json')) {
                ...
                // show something useful even if n8n returns custom JSON
    ...
    return (
        <div style={styles.wrap}>
            <div style={styles.chatBox}>
                <div style={styles.header}>n8n Webhook Chat Test</div>
                ...
                <div style={styles.controls}>
                    <input
                        ...
                        placeholder="Type a message to send to n8n…"
                    />
